...
//
int LagrangeElem2DNavierStokesQuad4Node::calcStiffnessAndResidual(vector<vector<double> >& node_coords, double* elemData, MatrixXd& Klocal, VectorXd& Flocal, double timeCur)
{
    // stabilised formulation
